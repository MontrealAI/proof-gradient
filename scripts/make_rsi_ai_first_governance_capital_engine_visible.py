...
def main():
    ...
    run_url = f"https://github.com/{m.get('github_repository','MontrealAI/proof-gradient')}/actions/workflows/autonomous-rsi-ai-first-governance-capital-engine-proof.yml"
    proof_url = f"https://montrealai.github.io/proof-gradient/{SLUG}.html"
