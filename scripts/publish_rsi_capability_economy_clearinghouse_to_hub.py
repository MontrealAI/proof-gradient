...
TITLE = 'Autonomous RSI Capability Economy Clearinghouse Proof'
...
<h2 style="font-size:clamp(30px,4.5vw,58px);line-height:.95;margin:0 0 12px">Autonomous RSI Capability Economy Clearinghouse Proof</h2>
<p style="color:#b8c8d8;font-size:18px;line-height:1.55">SkillOS proves that verified skill supply can meet demand through price discovery, liquidity, settlement trust, risk courts, and validation-gated RSI releases.</p>
