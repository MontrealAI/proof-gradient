...
<p class="links">
<a href="https://github.com/MontrealAI/proof-gradient/actions/workflows/rsi-cyberdefense-proof.yml">Run in GitHub Actions</a>
<a href="https://github.com/MontrealAI/proof-gradient/blob/main/docs/rsi_cyberdefense_market_proof.md">Markdown report</a>
<a href="https://github.com/MontrealAI/proof-gradient/blob/main/data/rsi_cyberdefense_market_proof.json">JSON proof</a>
</p>
</main>
</body>
</html>
