...
"""
    atomic(SITE/"index.html", layout("Proof Gradient Public Command Center v3","Home",index_body,generated_at))
...
def main() -> None:
    ...
    urls=["https://montrealai.github.io/proof-gradient/"]+[f"https://montrealai.github.io/proof-gradient/{x}" for x in ["executive.html","proofs.html","actions.html","skills.html","receipts.html","multi-agent.html","architecture.html","flywheel.html","health.html","runbook.html"]]
