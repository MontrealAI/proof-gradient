...
CARD = """
<section id="rsi-silicon-verification-proof" style="margin:48px 0;padding:28px;border:1px solid rgba(255,255,255,.14);border-radius:24px;background:rgba(255,255,255,.06)">
  ...
  <h2 style="font-size:clamp(30px,4vw,54px);line-height:1;margin:0 0 14px">Autonomous RSI Silicon Verification Market Proof</h2>
...
def main() -> None:
    ...
    if "rsi-silicon-verification-proof.html" in text and "Autonomous RSI Silicon Verification Market Proof" in text:
        print("RSI silicon verification proof card already visible.")
        return
    if "</main>" in text:
    ...
    print("RSI silicon verification proof card added to homepage.")
