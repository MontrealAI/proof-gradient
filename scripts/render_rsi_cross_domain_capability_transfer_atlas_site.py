...
</style></head><body><nav class='nav'><div class='brand'>SkillOS Transfer Atlas</div><div class='navlinks'><a href='index.html'>Command Center</a><a href='data/{PROOF_ID}.json'>JSON</a><a href='docs/{PROOF_ID}.md'>Report</a><a href='badges/{PROOF_ID}.svg'>Badge</a><a href='https://github.com/MontrealAI/proof-gradient/actions/workflows/autonomous-rsi-cross-domain-capability-transfer-atlas-proof.yml'>Run</a></div></nav>
<main class='wrap'><section class='hero'><div class='panel heroText'><div class='eyebrow'>MONTREAL.AI / PROOF GRADIENT / RSI TRANSFER ATLAS</div><h1>Capability transfer is the moat.</h1><p>Autonomous proof that a large specialist-agent organization can recursively improve how verified skills transfer across unseen domains — instead of winning only one demo, one workflow, or one benchmark.</p><div class='actions'><a class='btn primary' href='https://github.com/MontrealAI/proof-gradient/actions/workflows/autonomous-rsi-cross-domain-capability-transfer-atlas-proof.yml'>Run proof on GitHub</a><a class='btn' href='data/{PROOF_ID}.json'>Open JSON receipt</a><a class='btn' href='docs/{PROOF_ID}.md'>Read report</a></div></div><div class='panel proofBox'><span class='status'>Proof passed</span><div class='big'>{proof['large_agent_coordination']['virtual_specialist_agents']:,} agents.<br>{proof['large_agent_coordination']['specialist_roles']:,} roles.<br>{proof['benchmark_design']['locked_holdout_cases']:,} locked holdout cases.</div><p>{html.escape(proof['public_safe_claim'])}</p></div></section>
