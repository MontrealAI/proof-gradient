...
<nav><strong>SkillOS Objective Integrity Firewall</strong><span><a href='index.html'>Command Center</a><a href='proof-registry.json'>Registry</a><a href='data/{PROOF_ID}.json'>JSON</a><a href='docs/{PROOF_ID}.md'>Report</a><a href='https://github.com/MontrealAI/proof-gradient/actions'>Run</a></span></nav>
<main class='wrap'>
<section class='hero'>
  <div class='panel'><div class='eyebrow'>Objective Integrity / Goodhart Firewall</div><h1>Optimization that refuses to cheat.</h1><p class='lede'>A deterministic public benchmark showing that SkillOS RSI can improve hidden-objective performance while resisting proxy gaming, synthetic receipts, reward tampering, benchmark memorization, and coordination theater.</p><div class='flow'>{''.join(f"<span>{html.escape(x)}</span>" for x in r['mechanism'])}</div><div class='btns'><a class='btn' href='data/{PROOF_ID}.json'>Open receipt</a><a class='btn secondary' href='docs/{PROOF_ID}.md'>Read report</a><a class='btn secondary' href='https://github.com/MontrealAI/proof-gradient/actions'>Run on GitHub</a></div></div>
