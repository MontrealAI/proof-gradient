...
TITLE = 'Autonomous RSI Skill Compounding Moat Proof'
...
<h2 style="font-size:clamp(30px,4.5vw,58px);line-height:.95;margin:0 0 12px">Autonomous RSI Skill Compounding Moat Proof</h2>
<p style="color:#b8c8d8;font-size:18px;line-height:1.55">SkillOS proves that verified work traces become reusable skills, verified skills become signed releases, releases improve routing, and routing compounds future work across domains.</p>
