...
<p class="links"><a href="https://github.com/MontrealAI/proof-gradient/actions/workflows/rsi-capability-command-center-v17-proof.yml">Run in GitHub Actions</a><a href="https://github.com/MontrealAI/proof-gradient/blob/main/docs/rsi_capability_command_center_v17_proof.md">Markdown report</a><a href="https://github.com/MontrealAI/proof-gradient/blob/main/data/rsi_capability_command_center_v17_proof.json">JSON proof</a></p>
</main></body></html>"""
