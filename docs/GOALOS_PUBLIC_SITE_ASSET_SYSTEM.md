...
This document defines public-safe status and operating guidance for GoalOS Public Site Asset System.
...
Assets include QUEBEC.AI seal files, static badges, figures, and public site manifest assets. Preserve assets and validate public references.
