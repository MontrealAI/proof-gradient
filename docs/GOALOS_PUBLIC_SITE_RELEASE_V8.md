# GoalOS Public Site Release V8

This document defines public-safe status and operating guidance for GoalOS Public Site Release V8.
...
Current public website release package: GoalOS Public Site Release v8 Intelligent Assets. Release through the actual autonomous deployment workflow only; validate-only compatibility workflows do not configure, upload, or deploy GitHub Pages.
