# JOBS on Base Audit Handoff

Audit handoff requires package label, contracts, tests, static checks, deployment rehearsal, scope boundaries, operator roles, treasury/founder address verification, and claims review.
