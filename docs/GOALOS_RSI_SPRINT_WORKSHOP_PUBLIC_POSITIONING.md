...
Position the $2,500+ workshop as a gated Proof Card 001 engine.

## Current status

Ready as a gated founding workshop.

## Key decisions

Workshop copy must say build the first self-improving workflow live, not guarantee productivity or ROI.
...
Use workshop outcomes to generate public-safe proof only after approval.
