...
v14 is current. v12 and v13 are obsolete. Old v8 compatibility validation is not current unless updated to shared current rules. v14 preserves public proof microsite compatibility, canonical shell validation, paid-file guard behavior, blocked-claim checks, and the public AEP package allowlist.
